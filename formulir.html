                ...
                <form id="registrationForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="nama" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                         <div>
                            <label class="block text-gray-700">Nik</label>
                            <input type="text" id="nik" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Tempat Lahir</label>
                            <input type="text" id="tempat_lahir" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Tanggal Lahir</label>
                            <input type="date" id="tanggal_lahir" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Jenis Kelamin</label>
                            <select id="jenis_kelamin" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        ...
                        <div>
                            ...
                            <input type="text" id="agama" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Kewarganegaraan</label>
                            <input type="text" id="kewarganegaraan" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Moda Transportasi ke Sekolah</label>
                            <input type="text" id="transportasi" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Anak ke Berapa dalam Keluarga</label>
                            <input type="number" id="anak_ke" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Jumlah Saudara Kandung</label>
                            <input type="number" id="jumlah_saudara" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="sekolah_asal" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">NISN (Jika ada, jika belum isi 0)</label>
                        <input type="text" id="nisn" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="nama_ortu" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Pendidikan Terakhir</label>
                            <input type="text" id="pendidikan_ortu" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Pekerjaan</label>
                            <input type="text" id="pekerjaan_ortu" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Penghasilan Bulanan</label>
                            <input type="text" id="penghasilan" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                        <div>
                            <label class="block text-gray-700">Alamat Ortu</label>
                            <textarea id="alamat_ortu" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required></textarea>
                        </div>
                        <div>
                            <label class="block text-gray-700">Nomor Telepon</label>
                            <input type="text" id="nomor_telepon" class="w-full bg-green-600 text-white border-gray-300 rounded-md p-2" required>
                        </div>
                    </div>

                   
                    <div class="mb-4">
                        <label for="alamat" class="block text-white-700">Alamat Lengkap</label>
                        <textarea id="alamat" name="alamat" class="mt-1 block w-full bg-green-600  text-white border-gray-300 rounded-md p-2" required></textarea>
                    </div>
                    <button type="button" onclick="generatePDF()" class="bg-blue-700 text-white px-4 py-2 rounded-md">Download PDF</button>
                </form>
            </div>
        </div>
    </div>
  ...
  <div class="fixed bottom-4 right-4">
   <button class="bg-green-500 text-white px-4 py-2 rounded-full shadow-lg flex items-center">
    ...
    <a href="https://wa.me/6281249327710?text=Assalaamu'alaikum." class="text-white" target="_blank">
                                            ...
                                            <span class="d-none d-md-inline-block">KIRIM PDF KE SINI </span>
                                    </a>
    </i>
   </button>
    <script>
    ...
    doc.line(15, 35, 195, 35); // Garis bawah header
    ...
    doc.text("FORMULIR PENDAFTARAN PESERTA DIDIK BARU", 50, 45)
        ...
        Moda Transportasi ke Sekolah: ${transportasi}
        Anak ke Berapa: ${anakKe}
        Jumlah Saudara Kandung: ${jumlahSaudara}
        
        Nama Sekolah Asal: ${sekolahAsal}
        NISN: ${nisn}
    ...
    doc.setFontSize(12);
    let lines = doc.splitTextToSize(content, 180); // Membatasi lebar teks agar tidak keluar halaman
    doc.text(lines, 20, 55);

    // Simpan PDF
    doc.save("formulir_peserta_didik.pdf");
}
</script>
